...
use Pkj\Sbanken\Exceptions\PropertyNotFoundException;
use Pkj\Sbanken\Exceptions\PropertyReadOnlyException;
...
abstract class ValueObject
{
     ...
     *
     * @throws \Pkj\Sbanken\Exceptions\PropertyNotFoundException When property does not exist
     * @throws \Pkj\Sbanken\Exceptions\PropertyReadOnlyException When property is readonly (protected)
     *
     ...
     * @ignore This method is for internal use
     *
     * @throws \Pkj\Sbanken\Exceptions\PropertyNotFoundException exception on all reads to undefined properties so typos are not silently accepted.
     *
     * @param string $property Name of the property
     *
     * @return mixed
     ...
     * @ignore This method is for internal use
     *
     * @throws \Pkj\Sbanken\Exceptions\PropertyNotFoundException exception on all writes to undefined properties so typos are not silently accepted and
     * @throws \Pkj\Sbanken\Exceptions\PropertyReadOnlyException exception on readonly (protected) properties.
     *
     * @uses ::__set()
     *
     * @param string $property Name of the property
